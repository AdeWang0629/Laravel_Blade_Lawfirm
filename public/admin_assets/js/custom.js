$(function() {
	...
	$('.modal-effect').on('click', function(e) {
		...
		$('#addClient, #clientType, #caseType, #lawsuitCase, #addCourt, #addCaseStage, #deleteAllInSectionLawsuite, #addCaseSession, #addReceipts, #addDocuments, #lawsuiteNumber, #deleteAllInSectionConsultations, #addBranch, #addExpenseSection, #addPayment, #addLawsuitePaper, #deleteItem, #deleteItemModal, #restoreItemModal').addClass(effect);
	});
	// hide modal with effect
	$('#addClient, #clientType, #caseType, #lawsuitCase, #addCourt, #addCaseStage, #deleteAllInSectionLawsuite, #addCaseSession, #addReceipts, #addDocuments, #lawsuiteNumber, #deleteAllInSectionConsultations, #addBranch, #addExpenseSection, #addPayment, #addLawsuitePaper, #deleteItem, #deleteItemModal, #restoreItemModal').on('hidden.bs.modal', function(e) {
		$(this).removeClass(function(index, className) {
			return (className.match(/(^|\s)effect-\S+/g) || []).join(' ');
		});
		$(this).find('.form-control').closest('.form-group').show();
	});
});
