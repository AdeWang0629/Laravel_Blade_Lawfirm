<!-- Modal effects -->
<div class="modal" id="restoreItemModal">
        ...
        <div class="modal-content modal-content-demo">
            ...
            <form class="form-horizontal" action="#" method="POST">
                ...
                <div class="modal-body">
                    <label class="restore_label mb-0"></label>
                </div>
                <div class="modal-footer">
                    <button class="btn ripple btn-success save-btn" type="submit">{{ trans('site.restore') }}</button>
