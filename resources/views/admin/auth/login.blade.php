                    ...
                    <div class="card-sigin p-4">
                        ...
                        <div class="card-sigin">
                            <div class="main-signup-header">
                                ...
                                <h5 class="font-weight-semibold mb-4 text-center">{{ trans('site.login').' "'.trans('site.admin').'"' }}</h5>
                                ...
                                <div class="row row-xsr mt-3">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="main-signin-footer text-left">
                                            @if (Route::has('client.login.show'))
                                                <p>
                                                    <a href="{{ route('client.login.show') }}">{{ trans('site.login').' "'.trans_choice('site.clients', 0).'"' }}</a>
                                                </p>
                                            @endif
                                        </div>
                                    </div>
