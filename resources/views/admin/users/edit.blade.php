...
@section('title', trans('site.edit', ['attr' => removebeginninLetters(trans_choice('site.users', 0), 2)]))
...
@section('page-header')
	...
	<div class="breadcrumb-header justify-content-between">
		<div class="my-auto">
			<div class="d-flex">
				<h4 class="content-title mb-0 my-auto">{{ trans('site.home') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('site.edit', ['attr' => removebeginninLetters(trans_choice('site.users', 0), 2)]) }}</span>
			</div>
		</div>
                        ...
                        <div class="card-body pt-0">
                            <div class="row">
                                <div class="form-group col-lg">
                                    ...
                                    {{ Form::text('first_name', old('first_name', $user->first_name), ['class' => 'form-control ' . ( $errors->has('name') ? ' is-invalid' : ''), 'id' => 'name', 'placeholder' => trans('site.first_name')]) }}
                                    @error('first_name')
                                ...
                                <div class="form-group col-lg">
                                    ...
                                    {{ Form::text('last_name', old('last_name', $user->last_name), ['class' => 'form-control ' . ( $errors->has('name') ? ' is-invalid' : ''), 'id' => 'name', 'placeholder' => trans('site.last_name')]) }}
                                    @error('last_name')
                                        <span class="text-danger small" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                                <div class="form-group col-lg">
                                    ...
                                    {{ Form::email('email', old('email', $user->email), ['class' => 'form-control ' . ( $errors->has('email') ? ' is-invalid' : ''), 'id' => 'email', 'placeholder' => trans('site.email')]) }}
                                    @error('email')
                                        <span class="text-danger small" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-lg">
                                    ...
                                    {{ Form::text('user_name', old('user_name', $user->user_name), ['class' => 'form-control ' . ( $errors->has('user_name') ? ' is-invalid' : ''), 'id' => 'user_name', 'placeholder' => trans('site.name_attr', ['attr' => trans_choice('site.users', 0)])]) }}
                                    @error('user_name')
                                        <span class="text-danger small" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-lg">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('roles_id[]', [''=>'']+$roles, old('roles_id', $user->roles->pluck('id')->toArray()), ['class' => 'form-control select2bs4 ' . ($errors->has('roles_id') ? ' is-invalid' : '' ), 'id' => 'roles', 'placeholder' => trans('site.select_attr', ['attr' => trans_choice('site.roles', 1)]),  'multiple'=>'multiple']) }}
                                        @error('roles_id')
                                            <span class="text-danger small" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group col-lg">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('status', [1 => trans('site.active'), 0 => trans('site.in_active')], old('status', $user->status), ['class' => 'form-control ' . ($errors->has('status') ? ' is-invalid' : '' ), 'id' => 'status', 'placeholder' => trans('site.select_attr', ['attr' => trans('site.user_status')])]) }}
                                        @error('status')
                                            <span class="text-danger small" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group">
                                {{ Form::submit(trans('site.edit', ['attr' => trans_choice('site.users', 0)]), ['class' => 'btn btn-primary mb-2']) }}
                            </div>
                        </div>
                    </div>
                </div>
