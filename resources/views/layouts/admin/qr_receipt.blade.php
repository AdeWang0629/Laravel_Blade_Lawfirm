                            ...
                            <div class="card card-invoice">
                                <div class="card-body">
                                    <div class="myDivToPrint">
                                        ...
                                        <div class="row mg-t-10 header-top">
                                        ...
                                        <div class="mg-t-10">
                                            <table class="table table-bordered" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center font-weight-bold">{{ $receipt->debit }}</td>
                                                ...
                                                @if ($receipt->lawsuite != null && $receipt->consultation == null)
                                                    <tr>
                                                        ...
                                                        <td class="text-center font-weight-bold">{{ $receipt->lawsuite->lawsuiteRemaining }}</td>
